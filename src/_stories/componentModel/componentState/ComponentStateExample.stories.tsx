    ...
    render: (args) => (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <p style={{ margin: 0, color: '#555', fontSize: 13 }}>
                ...
                <i>Request More</i> sends a typed request through the bus, fetches a batch of
                texts from <b>fakerapi.it</b>, and appends them to the list. A{' '}
                <i>Loading…</i> indicator is driven by{' '}
                <code>m.$.pendingRequestCount</code>.
            </p>
